...
[**Public Website & Static Content	3**](#public-website-&-static-content)

[WEB-01 | Home Page & Value Proposition	3](#web-01-|-home-page-&-value-proposition)

[WEB-02 | Static Legal Pages (Terms, Privacy, About)	3](#web-02-|-static-legal-pages-\(terms,-privacy,-about\))

[WEB-03 | Plan Selection Redirection Logic	3](#web-03-|-plan-selection-redirection-logic)

[**Authentication & Identity Management	4**](#authentication-&-identity-management)

[AUTH-01 | Sign Up via Email & Password	4](#auth-01-|-sign-up-via-email-&-password)

[AUTH-02 | Sign Up / Log In via Social SSO	5](#auth-02-|-sign-up-/-log-in-via-social-sso)

[AUTH-03 | User Log In (Email)	5](#auth-03-|-user-log-in-\(email\))

[AUTH-04 | Email Verification ("Soft Gate" Access)	6](#auth-04-|-email-verification-\("soft-gate"-access\))

[AUTH-05 | Forgot Password / Reset	6](#auth-05-|-forgot-password-/-reset)

[AUTH-06 | User Logout	7](#auth-06-|-user-logout)

[AUTH-07 | Invite Acceptance (For Phase 2 Readiness)	7](#auth-07-|-invite-acceptance-\(for-phase-2-readiness\))

[AUTH-08 | Validation & Error Feedback	7](#auth-08-|-validation-&-error-feedback)

[**Onboarding & Workspace Management User Stories	8**](#onboarding-&-workspace-management-user-stories)

[ONB-01 | Set Workspace Name & URL Slug	8](#onb-01-|-set-workspace-name-&-url-slug)

[ONB-02 | Slug Validation & Auto-Suggestions	8](#onb-02-|-slug-validation-&-auto-suggestions)

[ONB-03 | Timezone Setup	9](#onb-03-|-timezone-setup)

[ONB-04 | Workspace Branding (Logo Upload)	9](#onb-04-|-workspace-branding-\(logo-upload\))

[ONB-05 | Onboarding Completion & Subscription Handoff	10](#onb-05-|-onboarding-completion-&-subscription-handoff)

[ONB-06 | Multi-Workspace Restriction (Phase 1 Logic)	10](#onb-06-|-multi-workspace-restriction-\(phase-1-logic\))

[ONB-07 | Business Profile & AI Context Setup	11](#onb-07-|-business-profile-&-ai-context-setup)

[**Social Account Integrations	11**](#social-account-integrations)

[PHASE 1: Core Connectivity (Solo Plan)	12](#phase-1:-core-connectivity-\(solo-plan\))

[Sub-Epic 5.1: Integrations Hub & Management	12](#sub-epic-5.1:-integrations-hub-&-management)

[SOC-P1-01 | Social Accounts Dashboard (Settings)	12](#soc-p1-01-|-social-accounts-dashboard-\(settings\))

[SOC-P1-02 | Solo Plan Limit Enforcement (The Gate)	12](#soc-p1-02-|-solo-plan-limit-enforcement-\(the-gate\))

[SOC-P1-03 | Disconnect Account & Draft Conversion	13](#soc-p1-03-|-disconnect-account-&-draft-conversion)

[Sub-Epic 5.2: Platform Connectors (OAuth)	13](#sub-epic-5.2:-platform-connectors-\(oauth\))

[SOC-P1-04 | Connect LinkedIn (Page vs. Profile Selection)	13](#soc-p1-04-|-connect-linkedin-\(page-vs.-profile-selection\))

[SOC-P1-05 | Connect X (Twitter)	14](#soc-p1-05-|-connect-x-\(twitter\))

[SOC-P1-06 | Connect Meta (Business Login)	14](#soc-p1-06-|-connect-meta-\(business-login\))

[**PHASE 2: Team & Operational Optimization	14**](#phase-2:-team-&-operational-optimization)

[Sub-Epic 5.3: Advanced Health & Team Limits	14](#sub-epic-5.3:-advanced-health-&-team-limits)

[SOC-P2-01 | Team Plan Limit Enforcement (10 Accounts)	14](#soc-p2-01-|-team-plan-limit-enforcement-\(10-accounts\))

[SOC-P2-02 | Token Health & Expiry Alerts	15](#soc-p2-02-|-token-health-&-expiry-alerts)

[Sub-Epic 5.4: Role-Based Access Control (RBAC)	15](#sub-epic-5.4:-role-based-access-control-\(rbac\))

[SOC-P2-03 | Role Restrictions (Creator vs. Admin)	15](#soc-p2-03-|-role-restrictions-\(creator-vs.-admin\))

[**PHASE 3: Agency Scale & Governance	15**](#phase-3:-agency-scale-&-governance)

[Sub-Epic 5.5: Agency Scale & Enterprise Features	16](#sub-epic-5.5:-agency-scale-&-enterprise-features)

[SOC-P3-01 | Agency Plan Limit Enforcement (25 Accounts)	16](#soc-p3-01-|-agency-plan-limit-enforcement-\(25-accounts\))

[SOC-P3-02 | Multi-Workspace Context Switching	16](#soc-p3-02-|-multi-workspace-context-switching)

### 

### Public Website & Static Content {#public-website-&-static-content}

#### WEB-01 | Home Page & Value Proposition {#web-01-|-home-page-&-value-proposition}
...
#### WEB-02 | Static Legal Pages (Terms, Privacy, About) {#web-02-|-static-legal-pages-(terms,-privacy,-about)}
...
#### WEB-03 | Plan Selection Redirection Logic {#web-03-|-plan-selection-redirection-logic}
...
#### AUTH-01 | Sign Up via Email & Password {#auth-01-|-sign-up-via-email-&-password}
...
| Field Label | Placeholder | Helper Text | Mandatory |
| ----- | ----- | ----- | ----- |
| **Email Address** | name@business.com | — | Yes |
| **Password** | Create a password | Must be 8-12 alphanumeric characters. | Yes |
| **Agree to Terms** | — | I agree to the Terms of Service | Yes |
| **Sign Up Button** | — | — | N/A |

#### AUTH-02 | Sign Up / Log In via Social SSO {#auth-02-|-sign-up-/-log-in-via-social-sso}
...
#### AUTH-03 | User Log In (Email) {#auth-03-|-user-log-in-(email)}
...
#### AUTH-04 | Email Verification ("Soft Gate" Access) {#auth-04-|-email-verification-("soft-gate"-access)}
...
#### AUTH-05 | Forgot Password / Reset {#auth-05-|-forgot-password-/-reset}
...
#### AUTH-06 | User Logout {#auth-06-|-user-logout}
...
#### AUTH-07 | Invite Acceptance (For Phase 2 Readiness) {#auth-07-|-invite-acceptance-(for-phase-2-readiness)}
...
#### AUTH-08 | Validation & Error Feedback {#auth-08-|-validation-&-error-feedback}
...
### Onboarding & Workspace Management User Stories {#onboarding-&-workspace-management-user-stories}

#### ONB-01 | Set Workspace Name & URL Slug {#onb-01-|-set-workspace-name-&-url-slug}
...
| Field Label | Placeholder | Helper Text | Mandatory |
| ----- | ----- | ----- | ----- |
| **Workspace Name** | e.g., Acme Agency | Your business or brand name. | Yes |
| **Workspace URL** | cydra.social/ | letters, numbers, and dashes only. | Yes |

#### ONB-02 | Slug Validation & Auto-Suggestions {#onb-02-|-slug-validation-&-auto-suggestions}
...
#### ONB-03 | Timezone Setup {#onb-03-|-timezone-setup}
...
• **Functional Logic:**  
    ...
    ◦ **Storage:** Save as the workspace\_default\_timezone in the database.  
• **Field Matrix:**  
    ◦ **Label:** Timezone  
    ◦ **Type:** Dropdown (Searchable)  
    ◦ **Default:** Browser Timezone (e.g., America/New\_York)  
    ◦ **Mandatory:** Yes

#### ONB-04 | Workspace Branding (Logo Upload) {#onb-04-|-workspace-branding-(logo-upload)}
...
#### ONB-05 | Onboarding Completion & Subscription Handoff {#onb-05-|-onboarding-completion-&-subscription-handoff}
...
• **Functional Logic:**  
    ...
    ◦ **Backend Action:**  
        ...
        2\. Link current User ID as Role: WORKSPACE\_ADMIN for this workspace.  
...
#### ONB-06 | Multi-Workspace Restriction (Phase 1 Logic) {#onb-06-|-multi-workspace-restriction-(phase-1-logic)}
...
#### ONB-07 | Business Profile & AI Context Setup {#onb-07-|-business-profile-&-ai-context-setup}
...
| Field Label | Placeholder | Helper Text | Data Type | Mandatory |
| ----- | ----- | ----- | ----- | ----- |
| **Industry / Niche** | e.g., SaaS, Legal, Health | Helps AI understand your market. | Dropdown \+ Custom | Yes |
| **Business Description** | e.g., We help startups scale... | What do you do? (Max 500 chars) | Text Area | Yes |
| **Target Audience** | e.g., CTOs, Busy Moms | Who are you talking to? | Text Input | No |
| **Brand Tone** | Select tone... | How should your posts sound? | Dropdown | No |
| **Website** | https:// |  | URL | No |
...
### Social Account Integrations {#social-account-integrations}

#### PHASE 1: Core Connectivity (Solo Plan) {#phase-1:-core-connectivity-(solo-plan)}
...
#### Sub-Epic 5.1: Integrations Hub & Management {#sub-epic-5.1:-integrations-hub-&-management}

#### SOC-P1-01 | Social Accounts Dashboard (Settings)  {#soc-p1-01-|-social-accounts-dashboard-(settings)}
...
• **Functional Logic:**  
    ...
    ◦ **Context:** Query database for connections linked strictly to the current active\_workspace\_id.  
...
#### SOC-P1-02 | Solo Plan Limit Enforcement (The Gate)  {#soc-p1-02-|-solo-plan-limit-enforcement-(the-gate)}
...
• **Functional Logic:**  
    ...
    ◦ **Check:** IF (Count(social\_connections) \>= 3\) THEN Block Action.  
...
#### SOC-P1-03 | Disconnect Account & Draft Conversion  {#soc-p1-03-|-disconnect-account-&-draft-conversion}
...
• **Functional Logic:**  
    ...
    ◦ **Backend Process:**  
        1\. Delete the token record from social\_connections.  
        2\. Query posts table for status \= 'SCHEDULED' AND account\_id \= \[Deleted ID\].  
...
#### Sub-Epic 5.2: Platform Connectors (OAuth) {#sub-epic-5.2:-platform-connectors-(oauth)}

#### SOC-P1-04 | Connect LinkedIn (Page vs. Profile Selection)  {#soc-p1-04-|-connect-linkedin-(page-vs.-profile-selection)}
...
• **Functional Logic:**  
    ...
    ◦ **Step 2:** User grants permissions (w\_organization\_social, r\_liteprofile, w\_member\_social).  
    ◦ **Step 3 (Import Modal):**  
...
#### SOC-P1-05 | Connect X (Twitter) {#soc-p1-05-|-connect-x-(twitter)}
...
• **Functional Logic:**  
    ...
    ◦ **Step 3:** Store oauth\_token and oauth\_token\_secret.  
...
#### SOC-P1-06 | Connect Meta (Business Login)  {#soc-p1-06-|-connect-meta-(business-login)}
...
#### PHASE 2: Team & Operational Optimization {#phase-2:-team-&-operational-optimization}

**Focus:** Expanding limits to 10 accounts, introducing Role-Based Access (RBAC), and automated health checks.

#### Sub-Epic 5.3: Advanced Health & Team Limits {#sub-epic-5.3:-advanced-health-&-team-limits}

#### SOC-P2-01 | Team Plan Limit Enforcement (10 Accounts)  {#soc-p2-01-|-team-plan-limit-enforcement-(10-accounts)}
...
**3\. Acceptance Criteria**  
• **Functional Logic:**  
    ◦ Update Max\_Accounts validation rule to **10** for Workspaces on Team Plan.  
    ◦ **Upgrade Trigger:** If user attempts 11th connection, show **Agency Upgrade Modal** ($299/mo).

#### SOC-P2-02 | Token Health & Expiry Alerts {#soc-p2-02-|-token-health-&-expiry-alerts}
...
• **Functional Logic:**  
    ...
    ◦ **Database:** Update connection\_status \= EXPIRED.  
...
#### Sub-Epic 5.4: Role-Based Access Control (RBAC) {#sub-epic-5.4:-role-based-access-control-(rbac)}

#### SOC-P2-03 | Role Restrictions (Creator vs. Admin)  {#soc-p2-03-|-role-restrictions-(creator-vs.-admin)}
...
#### PHASE 3: Agency Scale & Governance {#phase-3:-agency-scale-&-governance}

**Focus:** High-volume management (25 accounts), multi-workspace context switching, and White Labeling.

#### Sub-Epic 5.5: Agency Scale & Enterprise Features {#sub-epic-5.5:-agency-scale-&-enterprise-features}

#### SOC-P3-01 | Agency Plan Limit Enforcement (25 Accounts) {#soc-p3-01-|-agency-plan-limit-enforcement-(25-accounts)}
...
**3\. Acceptance Criteria**  
• **Functional Logic:**  
    ◦ Update Max\_Accounts validation rule to **25** for Workspaces on Agency Plan.  
    ◦ **Overage:** If user needs \>25, prompt to "Add Additional Workspace" or "Contact Sales".

#### SOC-P3-02 | Multi-Workspace Context Switching {#soc-p3-02-|-multi-workspace-context-switching}
...
• **Functional Logic:**  
    ...
    ◦ **System:** Triggers a re-fetch of the social\_connections list based on the new workspace\_id.  
...
• **Functional Logic:**  
    ...
    ◦ **Data Passed:** Pass User\_Email, Workspace\_ID, and Plan\_ID to Stripe metadata.  
    ◦ **Validation:** Stripe handles card number, CVC, and Zip code validation.  
    ◦ **Trial Logic:**  
        ▪ If Trial selected: Authorize 0.00*immediately*.*Schedulefirstchargeof*∗∗49.00\*\* after 7 days.  
...
• **Functional Logic:**  
    ...
    ◦ **Storage:** Sync this data back to billing\_profiles table in Cydra via Webhook.  
    ◦ **Validation:** Address fields are mandatory. Tax ID is optional (unless required by region).  
• **Field Matrix:**

| Field Label | Placeholder | Mandatory |
| ----- | ----- | ----- |
| **Name on Invoice** | Legal Business Name | Yes |
| **Billing Address** | Street, City, Zip | Yes |
| **Country** | Select Country | Yes |
| **VAT / Tax ID** | e.g. GB123456789 | No (Optional) |
...
• **Functional Logic:**  
    ...
    ◦ **Database Updates:**  
        1\. Set subscription\_status \= active (or trialing).  
        2\. Set current\_period\_end \= Date \+ 30 Days.  
        3\. **Credit Allocation:** Set ai\_credits\_balance \= **50** (Solo Limit).  
    ◦ **UI Redirection:**  
...
• **Functional Logic:**  
    ...
    ◦ **Capabilities (Stripe Native):**  
        ...
        ▪ Update Credit Card.  
        ▪ Cancel Subscription.  
    ◦ **Cancellation Logic:** If user cancels, set cancel\_at\_period\_end \= true. Allow access until the billing cycle ends.
...
• **Functional Logic:**  
    ...
    ◦ **Provisioning:**  
        ▪ On success, increment ai\_credits\_balance by \+50 or \+100.  
...
• **UI Elements:**  
    ...
    ◦ **Labels:** "50 Credits (15)"∣"100*Credits*(25)"
...
**3\. Acceptance Criteria**  
• **Functional Logic:**  
    ◦ **Trigger:** Admin attempts to invite a user when current\_users \== 5\.  
    ...
    ◦ **Action:**  
        ...
        ▪ Update Stripe Subscription quantity: seats\_addon\_qty \+ 1.  
...
• **Functional Logic:**  
    ...
    ◦ **Provisioning:** Immediately add \+75 to ai\_credits\_balance.   
*Assumption: Roll over or use first. Source says "Credits reset monthly" which implies use-it-or-lose-it, but top-ups usually carry over.*   
...
**3\. Acceptance Criteria**  
• **Functional Logic:**  
    ◦ **Trigger:** Admin clicks "Create Workspace" when workspace\_count \>= 5\.  
    ◦ **Modal:** "Limit Reached. Add an additional client workspace for **$39/month**?"  
    ◦ **Action:**  
        ▪ Calculate Proration.  
        ▪ Charge card immediately.  
        ▪ Update Stripe Subscription: workspace\_addon\_qty \+ 1.  
...
| Field Label | Field Type | Placeholder | Mandatory | Validation / Logic |
| ----- | ----- | ----- | ----- | ----- |
| **Select Platforms** | Multi-Select Dropdown | Select platforms... | **Yes** | User must select at least one (LinkedIn or X). \<br\>Selection triggers the character limit calculation. |
| **Post Content** | Text Area (Rich Text) | What do you want to share? | **Yes** | **Max Length:** Dynamic. \<br\>• If X selected: **280** chars. \<br\>• If LinkedIn selected: **3,000** chars. \<br\>• If Both: **280** chars. \<br\>**Hard Block:** User cannot type past limit. |
| **Character Counter** | Display Label | 0 / 280 | N/A | Updates in real-time. \<br\>Turns **Red** at 95% usage. |
...
• **Functional Logic:**  
    ...
    ◦ **Context Injection:** System retrieves Workspace\_Profile (Industry, Audience, Tone) from DB and appends to the n8n payload.  
    ◦ **Credit Check:**  
        ▪ Check ai\_credits\_balance \> 0\.  
...
• **UI Elements:**  
    ...
    ◦ **Credit Counter:** "Credits: 45/50" (Visible near the button).  
• **Field Matrix:** 

| Field Label | Field Type | Placeholder | Mandatory | Validation / Logic |
| ----- | ----- | ----- | ----- | ----- |
| **Topic / Idea** | Text Input | e.g., "3 tips for remote leadership" | **Yes** | Max **500** characters. \<br\>Used as the primary prompt for n8n. |
| **Workspace Context** | Hidden System Field | N/A | **Yes** | Injected automatically from **Workspace Settings** (Industry, Tone, Audience). \<br\>If empty, AI defaults to "Professional". |
| **Generate Button** | Action Button | Generate Draft | N/A | **Disabled** if ai\_credits\_balance \= 0\. \<br\>**Disabled** if Topic is empty. |
...
| Field Label | Field Type | Placeholder | Mandatory | Validation / Logic |
| ----- | ----- | ----- | ----- | ----- |
| **Add Media** | Button / File Picker | N/A | **No** | **File Types:** .jpg, .png only (No GIFs/Video in Phase 1). \<br\>**Max Size:** **5MB** (Strict X API limit). \<br\>**Quantity:** 1 Image per post. |
| **Alt Text** | Text Input | Describe this image... | **No** | Max **1,000** characters. \<br\>Used for accessibility on LinkedIn/X. |
| **Remove Image** | Icon Button (X) | N/A | N/A | Clears the uploaded file and resets the input. |

#### CONT-04 | Local Media Library (Upload & Select)

**1\. User Story:** As a **User**, I want to **upload images to a personal Media Library and select them when creating a post**, So that I can **store my brand assets once and reuse them across multiple posts without re-uploading every time.**  
**2\. Description:** This feature introduces a dedicated "Media" menu in the sidebar (or a dedicated repository view) and integrates that repository into the "Content Editor." It allows users to "upload and keep" assets as requested, rather than just one-off uploads.  
**3\. Acceptance Criteria**  
• **Functional Logic:**  
    ◦ **Library Management:**  
        ▪ **View:** New Sidebar Menu item: **"Media Library"**.  
        ▪ **Action:** Displays a grid of previously uploaded images.  
        ▪ **Upload:** "Upload Asset" button allows bulk upload of images.  
        ▪ **Delete:** Option to delete an image permanently from the library.  
    ◦ **Editor Integration (The "Select" Flow):**  
        ▪ In the **Content Editor** (Epic 6), clicking "Add Media" now presents two tabs:  
            1\. **Upload New:** (Existing logic from CONT-03).  
            2\. **Select from Library:** Opens a modal showing the user's stored images.  
    ◦ **Selection Logic:** User clicks an image in the modal \-\> Image is attached to the post draft.  
    ◦ **Storage Limits:**  
        ▪ Enforce **5MB** per file limit (X/Twitter API Constraint).  
        ▪ *Phase 1 Limit:* Max **50** stored images per Workspace (Soft limit for MVP to prevent storage abuse, TBD by Admin).  
• **Error Scenarios & Edge Cases:**  
    ◦ **File Too Large:** If user uploads a 15MB image to the library, show error: *"Image exceeds 5MB limit. Please resize."*.  
    ◦ **Unsupported Format:** If user uploads a .gif or .mp4 (Phase 1 exclusions), show: *"Only JPG and PNG are supported in Phase 1."*  
    ◦ **Empty State:** If Library is empty, the "Select from Library" tab shows: *"No assets yet. Upload your first image."*  
• **UI Elements:**  
    ◦ **Sidebar Icon:** "Media" or "Assets" icon.  
    ◦ **Modal Header:** "Select Media".  
    ◦ **Helper Text:** "Stored images can be reused for any future post."  
• **Quality Expectations:**  
    ◦ Images must render thumbnails quickly (lazy load if \>20 items).  
    ◦ Deleting an image from the Library should **not** break historical posts that have already been published, but *should* remove it from being selected for new Drafts.

#### CONT-05 | Auto-Save & Draft Management
...
| UI Element | Field Type | Default State | Logic |
| ----- | ----- | ----- | ----- |
| **Save Status** | Text Indicator | "Saved" | **States:** \<br\>• "Saving..." (Spinner) \<br\>• "Saved at \[Time\]" (Gray text) \<br\>• "Save Failed" (Red text \+ Retry icon) |
| **Last Edited** | Timestamp | N/A | Updates on every successful database sync (30s interval). |
...
**3\. Acceptance Criteria**  
• **Functional Logic:**  
    ◦ **Check:** IF workspace.approval\_required \= TRUE.  
    ◦ **UI Change:** Replace "Schedule/Publish" button with "Submit for Approval".  
    ◦ **Action:**  
        ▪ Change Post Status to PENDING\_APPROVAL.  
...
• **Functional Logic:**  
    ...
    ◦ **Validation (The 15-Minute Rule):**  
        ▪ User cannot select a time less than **15 minutes** from Current\_Server\_Time.  
...
| Field Label | Field Type | Placeholder | Mandatory | Validation / Logic |
| ----- | ----- | ----- | ----- | ----- |
| **Publish Action** | Radio/Toggle | "Publish Now" (Default) | Yes | If "Schedule" selected, reveal Date/Time fields. |
| **Date** | Date Picker | MM/DD/YYYY | Yes (if Sched) | Must be Today or Future. |
| **Time** | Time Picker | HH:MM AM/PM | Yes (if Sched) | Must be \> (Current Time \+ 15 mins). |
| **Timezone** | Read-Only Text | e.g. "America/New\_York" | N/A | Pulled from Workspace Settings. |
...
**3\. Acceptance Criteria**  
• **Functional Logic:**  
    ◦ **Queue Polling:** System checks the database every 1 minute (or appropriate interval) for posts where status \= SCHEDULED AND scheduled\_time \<= Current\_Time.  
    ...
    ◦ **Execution:**  
        ...
        3\. **On Success (200 OK):** Update status to PUBLISHED. Capture platform\_post\_id (if available).  
...
| Field Label | Field Type | Validation / Logic |
| ----- | ----- | ----- |
| **Status Badge** | UI Tag | Dynamic based on DB status. |
| **Error Message** | Tooltip | Visible only if Status \= Failed. |
...
• **Functional Logic:**  
    ...
    ◦ **Results View:**  
        ...
        ▪ **Workspace Details:** Workspace Name, Plan Type (Solo), Status (Active/Past\_Due), AI Credit Balance.  
...
| Field Label | Placeholder | Mandatory | Validation |
| ----- | ----- | ----- | ----- |
| **Search Query** | Email, Name, or Slug | Yes | Min 3 characters. |
| **Filter** | User / Workspace | Yes | Default: All. |
...
• **Functional Logic:**  
    ...
    ◦ **Security:**  
        ▪ Log this event in admin\_audit\_logs (Admin ID, Target User ID, Timestamp).  
...
• **Functional Logic:**  
    ...
    ◦ **System Action:**  
        ...
        ▪ If checked, set subscription\_status \= CANCELED.  
    ◦ **Logging:** Save refund\_reason and ticket\_id to database.  
• **Field Matrix:**

| Field Label | Field Type | Mandatory | Logic |
| ----- | ----- | ----- | ----- |
| **Refund Type** | Dropdown | Yes | Full / Partial |
| **Amount** | Currency | Yes (if Partial) | Max \= Original Charge Amount |
| **Reason Code** | Dropdown | Yes | Duplicate, Fraud, Customer Dissatisfaction, Other |
| **Ticket ID** | Text | No | Link to Support Desk ticket |
...
• **Functional Logic:**  
    ...
    ◦ **Action:**  
        ▪ Flag Workspace as RISK\_REVIEW.  
        ▪ Send Email Alert to Admins.  
    ◦ **Admin UI:** "Risk Queue" showing flagged accounts with "Suspend" or "Ignore" buttons.

### Email Notifications 

####  Authentication & Security (Transactional)

*These are critical, high-priority emails required for the user to access the system.*

| Email Name | Trigger | Recipient | Key Content / Call to Action |
| ----- | ----- | ----- | ----- |
| **Verify Your Email** | User signs up (Phase 1). | New User | "Welcome to Cydra\! Please verify your email to start." \[Verify Email Button\]. Link expires in 24h. |
| **Reset Your Password** | User clicks "Forgot Password". | User | "We received a request to reset your password." \[Reset Password Button\]. Link expires in 24h. |
| **Password Changed** | Password successfully updated. | User | "Security Alert: Your password was just changed. If this wasn't you, contact support." |
| **New Device / Location Login** | Login detected from new IP/Device (Phase 3 Security). | User | "We detected a login from \[Location\]. Is this you?" |
| **Account Locked (Failed Attempts)** | 5+ failed login attempts. | User | "For your security, your account is temporarily locked. Unlock it here." |

#### Subscription & Billing (Monetization)

*These emails drive revenue, reduce churn, and ensure compliance.*

| Email Name | Trigger | Recipient | Key Content / Call to Action |
| ----- | ----- | ----- | ----- |
| **Subscription Confirmation** | Successful payment for new plan. | User | "You're in\! Your \[Solo/Team/Agency\] Plan is active." \[Go to Dashboard\]. |
| **Trial Started** | User starts 7-Day Free Trial. | User | "Your trial has started. You have 7 days free. First charge: \[Date\]." |
| **Trial Ending Soon** | 3 days before trial ends. | User | "Your trial ends in 3 days. You will be charged $49 on \[Date\] unless you cancel." |
| **Payment Failed (Dunning)** | Stripe charge fails (Retry 1). | User | "Action Required: We couldn't process your payment. Update card to keep posting." |
| **Subscription Canceled** | User cancels plan. | User | "We're sorry to see you go. Your access remains active until \[End Date\]." |
| **Invoice Receipt** | Monthly recurring charge success. | User | "Here is your invoice for \[Month\]. Amount: $\[Price\]." (Attached PDF). |
| **Upgrade Confirmation** | User upgrades (Solo → Team). | User | "Upgrade successful\! You now have access to \[New Features\]." |
| **Credits Purchased** | User buys Top-Up (e.g., \+50 Credits). | User | "Receipt: You've added 50 AI Credits. Total Balance: \[X\]." |

#### Social Integrations & System Health

*These are operational alerts to prevent "Silent Failures" where posts don't go out.*

| Email Name | Trigger | Recipient | Key Content / Call to Action |
| ----- | ----- | ----- | ----- |
| **Social Connection Expired** | Token expires (e.g., LinkedIn 60 days) or API returns 401\. | User | "Alert: Reconnect \[LinkedIn/X\] to keep your schedule running." \[Reconnect Now\]. |
| **Post Published Successfully** | Post status changes to Published. | Creator | "Success\! Your post to \[Platform\] is live. View it here: \[Link\]." |
| **Post Failed to Publish** | Post status changes to Failed (after retries). | Creator | "Action Required: Your post to \[Platform\] failed. Reason: \[Error Message\]. Fix it here." |
| **Daily Digest (Optional)** | 8:00 AM daily summary (Phase 2). | User | "Today's Agenda: 2 Posts Scheduled, 1 Draft waiting for review." |

#### Collaboration & Approvals (Team/Agency Plans)

*These emails facilitate the workflow between Creators and Approvers.*

| Email Name | Trigger | Recipient | Key Content / Call to Action |
| ----- | ----- | ----- | ----- |
| **Workspace Invitation** | Admin invites a new user. | Invitee | "\[Admin Name\] invited you to join \[Workspace\] on Cydra." \[Join Team Button\]. |
| **Review Request** | Creator submits post for approval. | Approver | "Review Needed: \[Creator\] submitted a post for \[Date\]. Approve or Reject." \[Magic Link\]. |
| **Post Approved** | Approver clicks "Approve". | Creator | "Good news\! Your post was approved and is now scheduled." |
| **Post Rejected** | Approver clicks "Reject". | Creator | "Update Needed: Your post was rejected. Comment: '\[Reason\]'." |
| **Removed from Workspace** | Admin removes a user. | User | "Access Revoked: You no longer have access to \[Workspace\]." |

#### Onboarding & Engagement (Lifecycle)

*These emails drive adoption and prevent "Zero-State" churn.*

| Email Name | Trigger | Recipient | Key Content / Call to Action |
| ----- | ----- | ----- | ----- |
| **Welcome to Cydra** | Immediately after Email Verification. | User | "Welcome\! Here are 3 steps to get started: 1\. Connect Account, 2\. Create Post." |
| **Nudge: Connect Account** | User signed up but has 0 connections after 24h. | User | "You're almost there\! Connect LinkedIn or X to start posting." |
| **Nudge: Create First Post** | User connected but hasn't posted after 48h. | User | "Writer's block? Use our AI to generate your first draft in seconds." |
| **Milestone: 10th Post** | User publishes 10th post. | User | "High five\! You're building consistency. Keep it up\!" |
